...
class Options {
    constructor(writer, options) {
        ...
        this.mode = (_m = options.mode) !== null && _m !== void 0 ? _m : presets_1.presets.default.mode;
        this.writer = writer;
    ...
    get genMaxGhosts() {
        ...
        if (this.writer.options.html)
            length = utils_1.filterHtml(this.writer.goalText).length;
        else
        ...
        if (this.glyphsFromString)
            charset += utils_1.filterDuplicates(this.writer.previousString +
                (this.writer.options.html
                    ? utils_1.filterHtml(this.writer.goalText)
